...
# TRAVELING_RUBY_RELEASE_TAG - set release tag eg TRAVELING_RUBY_RELEASE_TAG=rel20230601
...
#   $ curl -fsSL https://raw.githubusercontent.com/you54f/traveling-ruby/master/install.sh | TRAVELING_RUBY_RELEASE_TAG=rel-20230601 sh
# or
#   $ wget -q https://raw.githubusercontent.com/you54f/traveling-ruby/master/install.sh -O- | TRAVELING_RUBY_RELEASE_TAG=rel-20230601 sh
